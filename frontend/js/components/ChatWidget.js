...
// Base visual: Adwaita (.circular + .suggested-action): círculo 40px
// táctil con ícono de 16px (glyph pequeño en círculo amplio, como el
// .circular real de Adwaita: min 34px + ícono estándar) y margen externo
// 24px. Acento #3584e4, ícono blanco, plano. Hover "Aura": degradado de
// tonos vivos + glow e ícono con contraste. El panel del chat se agrega
// en la parte de frontend (pendiente); acá queda el toggle como stub.
(function () {
